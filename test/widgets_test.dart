...
void main() {
  ...
  testWidgets('CustomAnimatedContainer applies effects', (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
  ...
  testWidgets('CustomAnimatedList renders children in stagger', (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
  ...
  testWidgets('AnimatedText renders Text', (tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(body: AnimatedText('Animated Hello')),
      ),
    );
  ...
  testWidgets('AnimatedImage renders Image', (tester) async {
    ...
    final imageProvider = MemoryImage(Uint8List.fromList([
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(body: AnimatedImage(image: imageProvider)),
      ),
    );
    expect(find.byType(Image), findsOneWidget);
  });

  testWidgets('CustomAnimatedGrid renders children in stagger', (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
  ...
  testWidgets('AnimatedBottomNavigationBar renders items', (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
