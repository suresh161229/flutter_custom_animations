...
void main() {
  testWidgets(
    'Widget extensions avoid nesting and return CustomAnimatedWidgetChain',
  ...
  testWidgets('Widget extensions apply sequence builder', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Widget extensions apply stagger builder', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Widget extensions apply chain builder alias', (
    WidgetTester tester,
  ) async {
