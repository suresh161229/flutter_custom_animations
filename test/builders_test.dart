...
void main() {
  testWidgets('EffectBuilder applies single effect', (WidgetTester tester) async {
  ...
  testWidgets('ParallelBuilder applies multiple effects simultaneously', (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
  ...
  testWidgets('ChainBuilder applies chained effects', (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: ChainBuilder(
        chainedEffects: [
